...
class EvaluasiController extends Controller
{
    public function index(Request $request)
    {
        ...
        $wmhilang = DB::table('tbl_dil')->where('kondisi_wm','4')->count();
                ...
                return view('evaluasi.index',compact('totdilcount','wmbaik','wmrusak','wmburam','wmhilang','querywm1','querywm2','querywm3','querywm4'));
        }
    }
        ...
        // return view('evaluasi.index',compact('rada','rtidakada','ada','tidakada',
